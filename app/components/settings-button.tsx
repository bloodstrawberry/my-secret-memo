...
function AutoLockToggle() {
  ...
  return (
    <button
      ...
      disabled={isDisabled}
      className={`flex items-center justify-center gap-2 py-2.5 rounded-xl text-[11px] font-bold uppercase tracking-wider transition-all ${autoLockEnabled
        ? isDisabled
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 text-blue-500 transition-all text-xs font-bold text-left w-full group"
      >
        <Icon icon="material-symbols:settings-backup-restore" className="w-4 h-4 opacity-80 group-hover:opacity-100 transition-opacity" />
        <span className="whitespace-nowrap">옵션 초기화</span>
      </button>

      <button
        onClick={() => { resetData("memos"); setIsExpanded(false); }}
        className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-purple-500/10 hover:bg-purple-500/20 text-purple-500 transition-all text-xs font-bold text-left w-full group"
      >
        <Icon icon="material-symbols:description-outline" className="w-4 h-4 opacity-80 group-hover:opacity-100 transition-opacity" />
        <span className="whitespace-nowrap">메모장 초기화</span>
      </button>

      <button
        onClick={() => { resetData("todos"); setIsExpanded(false); }}
        className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-500 transition-all text-xs font-bold text-left w-full group"
      >
        <Icon icon="mdi:format-list-checks" className="w-4 h-4 opacity-80 group-hover:opacity-100 transition-opacity" />
      ...
      <button
        ...
        className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-500 transition-all text-xs font-bold text-left w-full group"
      >
        <Icon icon="material-symbols:warning-outline" className="w-4 h-4 opacity-80 group-hover:opacity-100 transition-opacity" />
